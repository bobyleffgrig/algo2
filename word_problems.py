print("Eсли беременная самка бегемота кассой 800 кг родит детеныша массой 40 кг. ") 
...
print("pешат разделить добычу поровну. то сколько целых монет достанется каждому?") 
input("Чтобы узнать. нажмите Enter.") 
print("107 // 4 -", 107 // 4) 
